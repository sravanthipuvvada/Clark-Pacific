...
namespace NativeMessaging
{
    public abstract class Host
    {
        ...
        private JObject Read()
        {
            ...
            string arg1 = new string(buffer);
            Utils.LogMessage(arg1);
            Utils.LogMessage("return stmt : " + JsonConvert.DeserializeObject<JObject>(arg1).ToString());
            return JsonConvert.DeserializeObject<JObject>(arg1);
        }
